...
public class AWSV4Auth {
    ...
    /**
     * Instantiates a new AWSV 4 auth.
     */
    private AWSV4Auth() {
    }
    ...
    public static class Builder {
         ...
         * Query parametes.
         *
         * @param queryParametes the query parametes
         * @return the builder
         */
         ...
         * Aws headers.
         *
         * @param awsHeaders the aws headers
         * @return the builder
         */
    ...
    private String prepareCanonicalRequest() {
        ...
        if (queryParametes != null && !queryParametes.isEmpty()) {
            for (Map.Entry<String, String> entrySet : queryParametes.entrySet()) {
                ...
                queryString.append(key).append("=").append(encode(value)).append("&");
            }
            queryString.append("\n");
        } else {
            queryString.append("\n");
     ...
     *
     * @param strSignature the str signature
     * @return the string
     */
